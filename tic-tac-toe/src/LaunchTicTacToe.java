...
class TicTacToe {
	...
	public static void insertPosition(char board[][], int position, char user) {
		...
		case 9:
			...
			break;
		default:
			System.out.println("Invalid position. Please re-enter the position between(1-9)");
		}
	}
...
//
//import tictactoe_game.TicTacToe;
//
//class TicTacToe{
//	public static void displayBoard(char board[][]) {
//		for(char y[]:board) {
...
//	}
//	
//	public static void insertPostion(char board[][], int position, String playerType) {
//		char ch;
...
//				TicTacToe.insertPostion(board, ppos, playerTurn);
//			}
//			else {
//				playerTurn = "CPU";
//				
//				System.out.println("CPU, please enter the position (1-9).");
//				int cpos = scan.nextInt();
//				TicTacToe.insertPostion(board, cpos, playerTurn);
//				
//			}
//			TicTacToe.displayBoard(board);
//		}
